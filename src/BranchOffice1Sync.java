...
public class BranchOffice1Sync {

    // MySQL database connection parameters
    private static final String DB_URL = "jdbc:mysql://localhost:3306/salesbo1";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                channel.basicPublish(exchangeName, "BO1" , null, json.getBytes("UTF-8"));
